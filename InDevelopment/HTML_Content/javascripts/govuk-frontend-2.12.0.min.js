!function (t, e) {
    ...
    (function (t) {
        ...
        "bind" in Function.prototype || Object.defineProperty(Function.prototype, "bind", {
            value: function (t) {
                ...
                var u = r.slice, d = r.concat, h = r.push, p = Math.max, f = this;
                if (!e(f)) throw new TypeError("Function.prototype.bind called on incompatible " + f);
                for (var b, m = u.call(arguments, 1), y = p(0, f.length - m.length), v = [], g = 0; g < y; g++) h.call(v, "$" + g);
        ...
        "document" in this && "classList" in document.documentElement && "Element" in this && "classList" in Element.prototype && ((e = document.createElement("span")).classList.add("a", "b"), e.classList.contains("b")) || function (t) {
            ...
            var o = function (t, i, r) {
                n(t.prototype, i, function () {
                    ...
                    if (s[a]) return t;
                    if (s[a] = !0, !1 === e) {
                        for (var c, l = o.mirror || document.createElement("div"), u = l.childNodes, d = u.length, h = 0; h < d; ++h) if (u[h]._R === s) {
                            c = u[h];
                            break
                        }
    ...
    r.prototype.handleKeyDown = function (t) {
        ...
        if ("true" === t.target.getAttribute("data-prevent-double-click")) return i ? (t.preventDefault(), !1) : void (i = setTimeout(function () {
            i = null
        }, 1e3))
    ...
    a.prototype.handleInputs = function (t, e) {
        ...
        if (t) {
            ...
            }))), t.setAttribute("role", "group"), n.setAttribute("role", "button"), n.setAttribute("aria-controls", o.id), s || (n.tabIndex = 0), !0 === (null !== t.getAttribute("open")) ? (n.setAttribute("aria-expanded", "true"), o.setAttribute("aria-hidden", "false")) : (n.setAttribute("aria-expanded", "false"), o.setAttribute("aria-hidden", "true"), s || (o.style.display = "none")), this.handleInputs(n, this.setAttributes.bind(this))
        }
        ...
        (e.setAttribute("aria-expanded", o ? "false" : "true"), n.setAttribute("aria-hidden", i ? "false" : "true"), s) || (n.style.display = o ? "none" : "", null !== t.getAttribute("open") ? t.removeAttribute("open") : t.setAttribute("open", "open"));
        return !0
    ...
    }, c.prototype.getDataset = function (t) {
        ...
        return e
    }, c.prototype.createCountMessage = function () {
    ...
    }, c.prototype.bindChangeEvents = function () {
        var t = this.$textarea;
    ...
    }, c.prototype.checkIfValueChanged = function () {
    ...
    }, l.prototype.setAttributes = function (t) {
        var e = t.checked;
    ...
    }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof global && global || {}), u.prototype.init = function () {
        var t = this.$module;
        ...
        return !!o && (window.history.pushState ? window.history.pushState(null, null, "#" + e) : window.location.hash = e, o.scrollIntoView(), n.focus({preventScroll: !0}), !0)
    ...
    }, d.prototype.toggleClass = function (t, e) {
        ...
        e(this.$inputs, function (t) {
            var e = "radio" === t.getAttribute("type"), n = t.getAttribute("aria-controls");
        ...
        t.setAttribute("id", "tab_" + e), t.setAttribute("role", "tab"), t.setAttribute("aria-controls", e), t.setAttribute("tabindex", "-1");
        ...
        t.removeAttribute("id"), t.removeAttribute("role"), t.removeAttribute("aria-controls"), t.removeAttribute("tabindex");
        ...
        t.setAttribute("aria-selected", "false"), t.classList.remove("govuk-tabs__tab--selected"), t.setAttribute("tabindex", "-1")
    }, p.prototype.highlightTab = function (t) {
        t.setAttribute("aria-selected", "true"), t.classList.add("govuk-tabs__tab--selected"), t.setAttribute("tabindex", "0")
        ...
        new r(o).init(), e(o.querySelectorAll('[data-module="accordion"]'), function (t) {
            new n(t).init()
        }), e(o.querySelectorAll("details"), function (t) {
            new a(t).init()
        }), e(o.querySelectorAll('[data-module="character-count"]'), function (t) {
            new c(t).init()
        }), e(o.querySelectorAll('[data-module="checkboxes"]'), function (t) {
            new l(t).init()
        }), new u(o.querySelector('[data-module="error-summary"]')).init(), new d(o.querySelector('[data-module="header"]')).init(), e(o.querySelectorAll('[data-module="radios"]'), function (t) {
            new h(t).init()
        }), e(o.querySelectorAll('[data-module="tabs"]'), function (t) {
            new p(t).init()
        })
    }, t.Accordion = n, t.Button = r, t.Details = a, t.CharacterCount = c, t.Checkboxes = l, t.ErrorSummary = u, t.Header = d, t.Radios = h, t.Tabs = p
});
